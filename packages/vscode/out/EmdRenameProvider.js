...
exports.EmdRenameProvider = void 0;
const vscode = __importStar(require("vscode"));
const tools_1 = require("./tools");
class EmdRenameProvider {
            ...
            for (let i = 0; i < lines.length; i++) {
                ...
                if (keyMatch.test(line)) {
                    const lineStart = document.positionAt(frontMatterStart +
                        frontMatterText.substring(0, frontMatterText.indexOf(line))
                            .length).line;
...
exports.EmdRenameProvider = EmdRenameProvider;
// Helper function to escape regex special characters
function escapeRegex(str) {
    return str.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
}
//# sourceMappingURL=EmdRenameProvider.js.map